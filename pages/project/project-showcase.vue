      ...
      <view class="project-list">
        ...
        >
          <view class="project-image-container">
            <image :src="project.coverImage" mode="aspectFill" class="project-image"></image>
          ...
          <view class="project-content">
            ...
            <view class="project-info">
              <view class="info-item">
                <SvgIcon name="renshu" size="28" color="#6b7280"></SvgIcon>
                <text class="info-text">{{ project.teamSize }}人团队</text>
              </view>
              <view class="info-item">
                <SvgIcon name="shijian" size="28" color="#6b7280"></SvgIcon>
                <text class="info-text">{{ project.startDate }}</text>
              </view>
            </view>
